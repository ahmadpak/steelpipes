    ...
    for sle in sl_entries:
      ...
      #       sql_query = '''
            ...
            for x in query_result:
                    ...
                    sle['total_scale_weight'] = x.total_scale_weight_um
...
def get_columns(filters):
    if filters.get('warehouse'):
        columns = [
            {"label": _("Date"), "fieldname": "date",
             "fieldtype": "Datetime", "width": 95},
            {"label": _("Item"), "fieldname": "item_code",
             "fieldtype": "Link", "options": "Item", "width": 200},
            {"label": _("Est. Weight(KG)"), "fieldname": "estimate_weight",
             "fieldtype": "Float", "precision": 2, "width": 60},
            {"label": _("Scale Weight(KG)"), "fieldname": "scale_weight",
             "fieldtype": "Float", "precision": 2, "width": 60},
            {"label": _("Total Scale Weight(KG)"), "fieldname": "total_scale_weight",
             "fieldtype": "Float", "precision": 2, "width": 100},
            {"label": _("Qty"), "fieldname": "actual_qty", "fieldtype": "Float",
             "precision": 2, "width": 60, "convertible": "qty"},
            {"label": _("Balance Qty"), "fieldname": "qty_after_transaction",
             "fieldtype": "Float", "precision": 2, "width": 100, "convertible": "qty"},
    ...
    columns = [
        ...
        {"label": _("Total Scale Weight(KG)"), "fieldname": "total_scale_weight",
         "fieldtype": "Float", "precision": 2, "width": 100},
        {"label": _("Qty"), "fieldname": "actual_qty", "fieldtype": "Float",
         "precision": 2, "width": 100, "convertible": "qty"},
        {"label": _("Balance Qty"), "fieldname": "qty_after_transaction",
         "fieldtype": "Float", "precision": 2, "width": 100, "convertible": "qty"},
        {"label": _("Voucher Type"),
         "fieldname": "voucher_type", "width": 110},
