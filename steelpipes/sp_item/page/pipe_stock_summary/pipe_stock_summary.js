  ...
  var field1 = page.add_field({
    ...
    change() {
      if (field1.get_value() == "") {
        ...
        // $("h5").css('color','blue');
        page.add_inner_button("Download", () =>
          download_stock(field1.get_value())
        );
              ...
              if (r.message) {
                ...
                if (itemstemp.pipe1_2inch) {
                  ...
                  for (var i in itemstemp.pipe1_2inch) {
                    newhtml +=
                      '<tr><td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe1_2inch[i].thickness +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe1_2inch[i].length +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe1_2inch[i].qty +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe1_2inch[i].weight +
                      "</td></tr>";
                  }
                  //});
                ...
                if (itemstemp.pipe3_4inch) {
                  ...
                  for (var i in itemstemp.pipe3_4inch) {
                    newhtml +=
                      '<tr><td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe3_4inch[i].thickness +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe3_4inch[i].length +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe3_4inch[i].qty +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe3_4inch[i].weight +
                      "</td></tr>";
                  }
                  //});
                ...
                if (itemstemp.pipe1inch) {
                  ...
                  for (var i in itemstemp.pipe1inch) {
                    newhtml +=
                      '<tr><td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe1inch[i].thickness +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe1inch[i].length +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe1inch[i].qty +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe1inch[i].weight +
                      "</td></tr>";
                  }
                ...
                if (itemstemp.pipe11_4inch) {
                  ...
                  for (var i in itemstemp.pipe11_4inch) {
                    newhtml +=
                      '<tr><td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe11_4inch[i].thickness +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe11_4inch[i].length +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe11_4inch[i].qty +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe11_4inch[i].weight +
                      "</td></tr>";
                  }
                ...
                if (itemstemp.pipe11_2inch) {
                  ...
                  for (var i in itemstemp.pipe11_2inch) {
                    newhtml +=
                      '<tr><td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe11_2inch[i].thickness +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe11_2inch[i].length +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe11_2inch[i].qty +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe11_2inch[i].weight +
                      "</td></tr>";
                  }
                ...
                if (itemstemp.pipe2inch) {
                  ...
                  for (var i in itemstemp.pipe2inch) {
                    newhtml +=
                      '<tr><td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe2inch[i].thickness +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe2inch[i].length +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe2inch[i].qty +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe2inch[i].weight +
                      "</td></tr>";
                  }
                ...
                if (itemstemp.pipe21_2inch) {
                  ...
                  for (var i in itemstemp.pipe21_2inch) {
                    newhtml +=
                      '<tr><td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe21_2inch[i].thickness +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe21_2inch[i].length +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe21_2inch[i].qty +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe21_2inch[i].weight +
                      "</td></tr>";
                  }
                ...
                if (itemstemp.pipe3inch) {
                  ...
                  for (var i in itemstemp.pipe3inch) {
                    newhtml +=
                      '<tr><td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe3inch[i].thickness +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe3inch[i].length +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe3inch[i].qty +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe3inch[i].weight +
                      "</td></tr>";
                  }
                ...
                if (itemstemp.pipe4inch) {
                  ...
                  for (var i in itemstemp.pipe4inch) {
                    newhtml +=
                      '<tr><td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe4inch[i].thickness +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe4inch[i].length +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe4inch[i].qty +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe4inch[i].weight +
                      "</td></tr>";
                  }
                ...
                if (itemstemp.pipe5inch) {
                  ...
                  for (var i in itemstemp.pipe5inch) {
                    newhtml +=
                      '<tr><td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe5inch[i].thickness +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe5inch[i].length +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe5inch[i].qty +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe5inch[i].weight +
                      "</td></tr>";
                  }
                ...
                if (itemstemp.pipe6inch) {
                  ...
                  for (var i in itemstemp.pipe6inch) {
                    newhtml +=
                      '<tr><td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe6inch[i].thickness +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe6inch[i].length +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe6inch[i].qty +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe6inch[i].weight +
                      "</td></tr>";
                  }
                ...
                if (itemstemp.pipe7inch) {
                  ...
                  for (var i in itemstemp.pipe7inch) {
                    newhtml +=
                      '<tr><td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe7inch[i].thickness +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe7inch[i].length +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe7inch[i].qty +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe7inch[i].weight +
                      "</td></tr>";
                  }
                ...
                if (itemstemp.pipe8inch) {
                  ...
                  for (var i in itemstemp.pipe8inch) {
                    newhtml +=
                      '<tr><td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe8inch[i].thickness +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe8inch[i].length +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe8inch[i].qty +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe8inch[i].weight +
                      "</td></tr>";
                  }
                ...
                if (itemstemp.pipe10inch) {
                  ...
                  for (var i in itemstemp.pipe10inch) {
                    newhtml +=
                      '<tr><td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe10inch[i].thickness +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe10inch[i].length +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe10inch[i].qty +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe10inch[i].weight +
                      "</td></tr>";
                  }
                ...
                if (itemstemp.pipe12inch) {
                  ...
                  for (var i in itemstemp.pipe12inch) {
                    newhtml +=
                      '<tr><td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe12inch[i].thickness +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe12inch[i].length +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe12inch[i].qty +
                      "</td>";
                    newhtml +=
                      '<td class="col-sm-4" style="border:1px solid">' +
                      itemstemp.pipe12inch[i].weight +
                      "</td></tr>";
                  }
...
function download_stock(warehouse) {
  ...
  // })
  var api_request =
    "/api/method/steelpipes.utils.generate_xlsx_item_stock?warehouse=" +
    warehouse;
  var w = window.open(frappe.urllib.get_full_url(api_request));
  if (!w) {
